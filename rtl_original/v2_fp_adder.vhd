...
architecture arch of v2_fp_adder is
    -- sufixos b, s, a, n = big, small, aligned, normalized
    signal signb, signs : std_logic;
    signal expb, exps : unsigned(3 downto 0);
    signal expn : unsigned(4 downto 0);
