-- ============================================================
-- fp_adder.vhd
-- Somador de ponto flutuante simplificado (13 bits), original.
-- Fonte: FPGA Prototyping by VHDL Examples - Pong P. Chu
-- Fornecido pela professora no PDF "Projeto_Final_Sistemas_Digitais".
-- NAO MODIFICAR este arquivo (Etapa 1 do projeto).
-- ============================================================
...
architecture arch of fp_adder is
    -- sufixos b, s, a, n para "big", "small", "aligned", "normalized"
...
begin
    ...
    -- desloca o significando de acordo com os zeros a esquerda
    with leado select
        sum_norm <=
    ...
    -- normaliza com condicoes especiais
